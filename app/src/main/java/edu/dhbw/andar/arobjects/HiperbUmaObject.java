...
public class HiperbUmaObject extends ARObject {
	...
	private HiperboloideUmaFolha hiperbUmaExt;
	private HiperboloideUmaFolha hiperbUmaInt;
	private HiperboloideUmaFolha hiperbUmaWire;

	public HiperbUmaObject(String name, String patternName, double markerWidth, double[] markerCenter, AndARGLES20Renderer renderer) {
		...
		hiperbUmaExt = new HiperboloideUmaFolha(1, 0);
		hiperbUmaInt = new HiperboloideUmaFolha(-1, 0);
		hiperbUmaWire = new HiperboloideUmaFolha(1, 1);
	}
	...
	public synchronized void draw( GL10 glUnused ) {
		...
		// Pass in the position information
		GLES20.glVertexAttribPointer(mPositionHandle, 3, GLES20.GL_FLOAT,
				false, 0, hiperbUmaWire.getWire()); // 3 = Size of the position data in elements.
