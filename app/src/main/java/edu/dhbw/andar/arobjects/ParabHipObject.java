...
public class ParabHipObject extends ARObject {
	...
	private ParaboloideHiperbolico parabHipExt;
	private ParaboloideHiperbolico parabHipInt;
	private ParaboloideHiperbolico parabHipWire;

	public ParabHipObject(String name, String patternName, double markerWidth, double[] markerCenter, AndARGLES20Renderer renderer) {
		...
		parabHipExt = new ParaboloideHiperbolico(1, 0);
		parabHipInt = new ParaboloideHiperbolico(-1, 0);
		parabHipWire = new ParaboloideHiperbolico(1, 1);
	}
	...
	public synchronized void draw( GL10 glUnused ) {
		...
		// Pass in the position information
		GLES20.glVertexAttribPointer(mPositionHandle, 3, GLES20.GL_FLOAT,
				false, 0, parabHipWire.getWire()); // 3 = Size of the position data in elements.
