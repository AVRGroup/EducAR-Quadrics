...
public class ParaboloideObject extends ARObject {
	...
	private Paraboloide paraboloideExt;
	private Paraboloide paraboloideInt;
	private Paraboloide paraboloideWire;

	public ParaboloideObject(String name, String patternName, double markerWidth, double[] markerCenter, AndARGLES20Renderer renderer) {
		...
		paraboloideExt = new Paraboloide(1, 0);
		paraboloideInt = new Paraboloide(-1, 0);
		paraboloideWire = new Paraboloide(1, 1);
	}
