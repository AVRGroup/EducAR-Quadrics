...
//		normalsb.put(0);
//		normalsb.put(-1.0f);
		normalsb.put(normal1.x);
		normalsb.put(normal1.y);
		normalsb.put(normal1.z);
...
//		normalsb.put(0);
//		normalsb.put(-1.0f);
		normalsb.put(normal2.x);
		normalsb.put(normal2.y);
		normalsb.put(normal2.z);
...
//		normalsb.put(0);
//		normalsb.put(-1.0f);
		normalsb.put(normal3.x);
		normalsb.put(normal3.y);
		normalsb.put(normal3.z);
...
//		normalsb.put(0);
//		normalsb.put(-1.0f);
		normalsb.put(normal4.x);
		normalsb.put(normal4.y);
		normalsb.put(normal4.z);
